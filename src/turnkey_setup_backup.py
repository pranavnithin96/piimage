...
def final_setup_screen(stdscr, setup, config):
    ...
    stdscr.addstr(13, 2, "Press ENTER to install and start monitoring, ESC to go back...")
    stdscr.refresh()
    ...
    if key == 27:  # ESC
        ...
        # Start installation
        stdscr.addstr(15, 2, "Installing Power Monitor Service...")
        stdscr.refresh()
        ...
        stdscr.addstr(16, 2, "✅ Configuration saved")
        stdscr.refresh()
        ...
        stdscr.addstr(17, 2, "✅ Power monitor script created")
        stdscr.refresh()
        ...
        stdscr.addstr(18, 2, "✅ Service installed and enabled")
        stdscr.refresh()
        
        # Mark setup complete
        setup.mark_setup_complete()
        stdscr.addstr(19, 2, "✅ Setup marked as complete")
        stdscr.refresh()
        
        # Start service
        try:
            subprocess.run(['sudo', 'systemctl', 'start', 'powermonitor'])
            stdscr.addstr(20, 2, "✅ Service started successfully!")
        except:
            stdscr.addstr(20, 2, "⚠️  Service installed but failed to start")
        
        stdscr.refresh()
        
        stdscr.addstr(22, 2, "🎉 Setup Complete!", curses.A_BOLD)
        stdscr.addstr(23, 2, f"Device '{config['DEVICE_ID']}' is now monitoring at: {config['LOCATION_NAME']}")
        stdscr.addstr(24, 2, "Monitor status with: journalctl -u powermonitor -f")
...
def main_setup_flow(stdscr):
    ...
    stdscr.addstr(12, 2, "Press ENTER to begin setup...")
    stdscr.refresh()
